        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                if nextPos in self.corners and nextPos not in visited_corners:
                    visited_corners.append(nextPos)
                successors.append(((nextPos, tuple(sorted(visited_corners))), action, 1))
...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    for i in unvisited_corners:
        longest.append(util.manhattanDistance(i, state[0]))

    return  max(longest)# Default to trivial solution
